...
namespace RUSUNAWAAA.Migrations
{
    ...
    [Migration("20250608153355_tambahrelasi2")]
    partial class tambahrelasi2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RUSUNAWAAA.Models.Laporan", b =>
                {
                    ...
                    b.Property<string>("UserNomorKTP")
                        .HasColumnType("text");

                    b.HasKey("Id_Laporan");

                    b.HasIndex("UserNomorKTP");
            ...
            modelBuilder.Entity("RUSUNAWAAA.Models.Laporan", b =>
                {
                    b.HasOne("RUSUNAWAAA.Models.User", null)
                        .WithMany("Laporans")
                        .HasForeignKey("UserNomorKTP");
                });
